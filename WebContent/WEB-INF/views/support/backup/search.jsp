      ...
      <div class="span-18 colborder">
        ...
        <form:form id="search" cssClass="search" method="post" commandName="article">
          <div class="row">
            <table>
              <tr>
                <td style="width: 280px;"><input type="text" name="keyword" value="Enter Your Search Word" cssClass="span-8"
                  cssErrorClass="span-8 validationFailed" style="width: 180px;" onfocus="if(this.value==this.defaultValue) this.value='';" /></td>
                <td style="float: left">
                  <div class="buttons">
                    <a id="searchButton" href="#" class="button action-m"><span>SEARCH</span></a> <input id="searchSubmit" type="submit" name="_eventId_submit"
                      class="hidden" />
                  </div>
                </td>
              </tr>
