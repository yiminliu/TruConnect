      ...
      <div class="span-18 colborder" style="min-height: 200px;">
        ...
        <table border="1" cellspacing="10">
          <tr style="float: middle;">
            <td><a id="createTicket" href="<spring:url value="/ticket/createTicket" />" class="button action-m"><span>Create Ticket</span></a></td>
            <!-- <td>
            ...
            <td><a id="showOpenTickets" href="<spring:url value="/ticket/showAllTickets" />" class="button action-m"><span>Show All Tickets</span></a></td>
            <td><a id="searchTickets" href="<spring:url value="/ticket/searchTickets" />" class="button action-m"><span>Search Tickets</span></a></td>
          </tr>
        </table>
        <table>
          <c:if test="${openTicketsCount > 0}">
