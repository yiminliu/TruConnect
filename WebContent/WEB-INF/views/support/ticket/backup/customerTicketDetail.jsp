...
<body>
  ...
  <div class="blueTruConnectGradient">
    <div class="container">
      <span style="align: center">Information about the issue: Issue ID ${ticket.id}</span>
    </div>
  </div>
  <div class="container">
    <div id="main-content">
            ...
            <td>
              <!--<form:form id="updateTicket" action="/TruConnect/ticket/updateTicket" method="get" commandName="ticket" >
                       ...
                       <div class="button action-m"> <input id="updateTicketSubmit" class="button action-m" type="submit" name="_eventId_submit" value="Update Ticket" style="padding-left: 5px; padding-right: 5px;"/></div>
                        </form:form>--> <a href="<spring:url value="/ticket/updateCustomerTicket/${ticket.id}" />" class="button action-m"><span>Update
                  The Ticket</span></a>
            </td>
            <td><a href="<spring:url value="/ticket/customerTicketOverview" />" class="button action-m"><span>Back To Ticket/Solution Page</span></a></td>
            <td>
              <!--<form:form id="decketDetailBack" action="/TruConnect/ticket" method="get" commandName="ticket" >                       
                      ...
                      </form:form>--> <a id="account" href="<spring:url value="/account" />" class="button action-m"><span>Back To Account Overview</span></a>
            </td>
          </tr>
        </table>
      </div>
      ...
      <div class="span-6 last sub-navigation">
        <span style="float: right; float: bottom;"><%@ include file="/WEB-INF/views/include/navigation/accountNav.jsp"%></span>
      </div>
    </div>
    <!-- main-content -->
  </div>
