      ...
      <div class="span-18 colborder">
        <table border="1" cellspacing="10">
          ...
          <c:forEach var="ticket" items="${ticketList}">
            <tr>
              ...
              <td><a href="<spring:url value="/ticket/customerTicketDetail/${ticket.id}" />"><img class="info"
        ...
        <table cellspacing="10">
          <tr style="float: center">
            ...
            <td><a id="account" href="<spring:url value="/account" />" class="button action-m"><span>Back To Account Overview</span></a></td>
          </tr>
        </table>
      </div>
      <!-- close main-content -->
