...
<body>
  ...
  <div class="blueTruConnectGradient">
    <div class="container">Administrative Panel</div>
  </div>
      ...
      <div class="span-9" style="border: 1px #aaa solid; border-radius: 5px; padding: 20px;">
        <form id="loginForm" action="<spring:url value='/j_spring_security_check' />" method="post">
          <div>
            ...
            <div class="span-9">
              <a id="loginFormButton" href="#" class="button action-m" style="float: right;"><span>Sign In</span> </a> <input
                id="loginFormSubmit" type="submit" class="hidden" /> <a
