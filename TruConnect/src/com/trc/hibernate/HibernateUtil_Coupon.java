...
public class HibernateUtil_Coupon {
	...
	private static SessionFactory buildSessionFactory() {
		try {
			return new Configuration().configure(configurationFile).addAnnotatedClass(Coupon.class)
					.addAnnotatedClass(Contract.class).addAnnotatedClass(CouponDetail.class).buildSessionFactory();
		} catch (Throwable ex) {
