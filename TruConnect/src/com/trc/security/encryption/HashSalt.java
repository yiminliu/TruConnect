...
public class HashSalt {
	...
	public static byte[] getHash(String message, byte[] salt) throws NoSuchAlgorithmException, UnsupportedEncodingException {
		return getHash(iterations, message, salt);
	}

	public static byte[] getHash(int iterations, String message, byte[] salt) throws NoSuchAlgorithmException, UnsupportedEncodingException {
