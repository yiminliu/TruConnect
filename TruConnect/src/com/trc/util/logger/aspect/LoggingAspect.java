...
public class LoggingAspect {
	...
	public void afterThrowing(JoinPoint joinPoint, Throwable throwable) {
		...
		logger.log(LogLevel.ERROR, clazz, throwable, AFTER_THROWING, loggingHelper.getUserStamp(), name,
				throwable.getMessage(), constructArgString(clazz, joinPoint.getArgs()));
	}
	...
	public void afterReturning(JoinPoint joinPoint, Loggable loggable, Object returnValue) {
		...
		logger.log(loggable.value(), clazz, null, AFTER_RETURNING, loggingHelper.getUserStamp(), name,
				constructArgString(clazz, returnValue), elapsedTime);
		start = 0;
		elapsedTime = 0;
	}
